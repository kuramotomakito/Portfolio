                ...
                <article>
                    ...
                    <section>
                        ...
                        <div className="summary">
                            ...
                            <p>高校の頃からプログラミングを学ぶ一方、将来の夢は好きなファッションのデザイナーを目指していた。その中で、「学んできたプログラミングとなりたいデザイナーの両方を利用する職業はないか」と考えた際に、Web業界を知る。現在は日本電子専門学校 Webデザイン科に在学し、Webサイト構築フロー全ての工程を学び実践しながら、「日々新しいものに挑戦し続けるフロントエンドエンジニア」を目指している。</p>
                            <div className="prof">
                                <dl>
                                    <dt>趣味</dt>
                                    <dd>ラーメン屋巡り、楽器を吹く、映画鑑賞</dd>
                                    <dt>資格・特技</dt>
                                    <dd>文部科学省後援 色彩検定2級 取得<br />
